...
-- Dump completed on 2024-11-01 15:42:38
...
--
-- Table structure for table `favoritos_artur`
--

DROP TABLE IF EXISTS `favoritos_artur`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `favoritos_artur` (
...
--
-- Dumping data for table `favoritos_artur`
--

LOCK TABLES `favoritos_artur` WRITE;
/*!40000 ALTER TABLE `favoritos_artur` DISABLE KEYS */;
/*!40000 ALTER TABLE `favoritos_artur` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `favoritos_professor`
--

DROP TABLE IF EXISTS `favoritos_professor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `favoritos_professor` (
  `id` int NOT NULL AUTO_INCREMENT,
  `ano` varchar(50) DEFAULT NULL,
  `modalidade` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `favoritos_professor`
--

LOCK TABLES `favoritos_professor` WRITE;
/*!40000 ALTER TABLE `favoritos_professor` DISABLE KEYS */;
INSERT INTO `favoritos_professor` VALUES (12,'2008','futebol_feminino'),(13,'2012','futebol_feminino'),(14,'2012','boxe_92kg'),(15,'2016','basquete'),(16,'2016','futebol_feminino'),(17,'2016','boxe_92kg'),(18,'2020','basquete'),(19,'2020','futebol_feminino'),(20,'2020','boxe_92kg'),(21,'2024','basquete'),(22,'2024','futebol_feminino'),(23,'2024','boxe_92kg');
/*!40000 ALTER TABLE `favoritos_professor` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `favoritos_visualizar` VALUES (15,'2012','boxe_92kg');
/*!40000 ALTER TABLE `favoritos_visualizar` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `favoritos_wendel_ryan`
--

DROP TABLE IF EXISTS `favoritos_wendel_ryan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `favoritos_wendel_ryan` (
  `id` int NOT NULL AUTO_INCREMENT,
  `ano` varchar(50) DEFAULT NULL,
  `modalidade` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `favoritos_wendel_ryan`
--

LOCK TABLES `favoritos_wendel_ryan` WRITE;
/*!40000 ALTER TABLE `favoritos_wendel_ryan` DISABLE KEYS */;
INSERT INTO `favoritos_wendel_ryan` VALUES (1,'2024','basquete'),(3,'2012','boxe_92kg'),(4,'2024','boxe_92kg');
/*!40000 ALTER TABLE `favoritos_wendel_ryan` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `usuarios` VALUES (1,'eduardo','123456',1,0),(2,'bernardo','123456',1,0),(3,'leonardo','123456',1,0),(4,'visualizar','123456',0,0),(5,'artur','$@jK%50r:_1156j',0,0),(6,'Wendel Ryan','123456',0,0),(7,'professor','123456',0,0);
