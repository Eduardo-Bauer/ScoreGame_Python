...
--
-- Table structure for table `favoritos_teste`
--

DROP TABLE IF EXISTS `favoritos_teste`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `favoritos_teste` (
  `id` int NOT NULL AUTO_INCREMENT,
  `ano` varchar(50) DEFAULT NULL,
  `modalidade` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `favoritos_teste`
--

LOCK TABLES `favoritos_teste` WRITE;
/*!40000 ALTER TABLE `favoritos_teste` DISABLE KEYS */;
/*!40000 ALTER TABLE `favoritos_teste` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `favoritos_visualizar` VALUES (8,'2024','basquete'),(9,'2024','futebol_feminino'),(10,'2024','boxe_92kg');
...
INSERT INTO `usuarios` VALUES (1,'eduardo','123456',1,0),(2,'bernardo','123456',1,0),(3,'leonardo','123456',1,0),(4,'visualizar','123456',0,0),(5,'artur','$@jK%50r:_1156j',0,0),(7,'teste','123456',0,0);
...
-- Dump completed on 2024-10-08  7:24:02
